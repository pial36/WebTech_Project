...
.socialbtns .fa:hover {
    ...
    <a style="background-color:#ddd;color:black;" href="../controllers/Home.php">Home</a> 
     ...
     <a style="float: right;" href="../controllers/CLogin.php">Sign up / Log in </a>
     </div>
     <div class="container">
...
<ul>
<li><a href="https://www.facebook.com/pialhassanc" class="fa fa-lg fa-facebook"></a></li>
<li><a href="#" class="fa fa-lg fa-twitter"></a></li>
<li><a href="#" class="fa fa-lg fa-google-plus"></a></li>
<li><a href="https://github.com/pial36" class="fa fa-lg fa-github"></a></li>
